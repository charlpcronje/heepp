<?php 
namespace core\extension\document\excel;

Class ExcelWriter extends \core\Heepp {
        ...
        $header = '<<<EOH 
            ...
            <!--[if gte mso 9]><xml> 
             <o:DocumentProperties> 
              <o:LastAuthor>Excel Export</o:LastAuthor> 
              <o:LastSaved>'.date('Y-m-d').'T'.date('G:i:s').'Z</o:LastSaved> 
