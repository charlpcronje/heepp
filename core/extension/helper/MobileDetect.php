...
class MobileDetect extends \core\extension\Extension {
    /**
    ...
    protected static $phoneDevices = array(
        ...
        // @DO: Is 'Dell Streak' a tablet or a phone? ;)
    ...
    protected static $tabletDevices = array(
        'iPad'              => 'iPad|iPad.*Mobile', // @DO check for mobile friendly emails topic.
        ...
        // @DO http://www.nbhkdz.com/read/b8e64202f92a2df129126bff.html - investigate
        ...
        // @DO inspect http://esupport.sony.com/US/p/select-system.pl?DIRECTOR=DRIVER
        ...
        // @DO add more tests.
        'OvermaxTablet'     => 'OV-(SteelCore|NewBase|core|Baseone|Exellen|Quattor|EduTab|Solution|ACTION|BasicTab|TeddyTab|MagicTab|Stream|TB-08|TB-09)',
        ...
        // @DO add them gradually to avoid conflicts.
    ...
    protected static $operatingSystems = array(
        ...
        // @DO research MeeGo in UAs
        'MeeGoOS'           => 'MeeGo',
        // http://en.wikipedia.org/wiki/Maemo
        // @DO research Maemo in UAs
        'MaemoOS'           => 'Maemo',
    ...
    public function setUserAgent($userAgent = null)
    {
        if (!empty($userAgent)) {
            ...
            foreach($this->getUaHttpHeaders() as $altHeader){
                if(!empty($this->httpHeaders[$altHeader])){ // @DO should use getHttpHeader(), but it would be slow. (Serban)
     ...
     *
     * @return array List of application types.
     */
     ...
     * userAgent.
     * @DO The httpHeaders part is not yet used.
     *
     * @param string $key
     * @param string        $userAgent   deprecated
     ...
     * @return bool
     *
     * @DO search in the HTTP headers too.
     */
    ...
    public function prepareVersionNo($ver)
    {
        ...
        if (isset($arrVer[1])) {
            $arrVer[1] = @str_replace('.', '', $arrVer[1]); // @DO treat strings versions.
        }
    ...
    public function mobileGrade()
    {
        ...
        if (
            ...
            // @DO report this (tested on Nokia N71)
