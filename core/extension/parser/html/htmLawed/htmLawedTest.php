...
/*
htmLawedTest.php, 31 August 2017
To test htmLawed OOP class
...
<html lang="en" xml:lang="en">
    <head>
        ...
        #inputC, #inputD, #inputF, #inputR, #outputD, #outputF, #outputR, #settingF, #diff {
            display: block;
        }
        ...
        (function () {
            ...
            diff_match_patch.prototype.diff_main = function (a,b,c,d) {
                ...
                var e                                                                 = c,f                                                           = this.diff_commonPrefix(a,b),c = a.substring(0,f),a      = a.substring(f),
                    b                                                                 = b.substring(f),f                                              = this.diff_commonSuffix(a,b),g = a.substring(a.length - f),
            ...
            diff_match_patch.prototype.diff_compute_ = function (a,b,c,d) {
                ...
                ],c)) : c && 100 < a.length && 100 < b.length ? this.diff_lineMode_(a,
                    b,d) : this.diff_bisect_(a,b,d);
            };
            diff_match_patch.prototype.diff_lineMode_ = function (a,b,c) {
                var d = this.diff_linesToChars_(a,b),a = d.chars1,b = d.chars2,d = d.lineArray,
                ...
                for(var k = d - e,p = 0 != k % 2,q = 0,s = 0,o = 0,v = 0,u = 0; u < f && !((new Date).getTime() > c); u++) {
                    ...
                    for(n = -u + o; n <= u - v; n += 2) {
                        ...
                        if (t > d) {
                            ...
                            o += 2;
                        } else if (!p && (l = g + k - n, 0 <= l && l < h && -1 != j[l] && (m = j[l], r = g + m - l, t = d - t, m >= t))) {
                            return this.diff_bisectSplit_(a,b,m,r,c);
                        }
                    }
                }
            ...
            diff_match_patch.prototype.diff_bisectSplit_ = function (a,b,c,d,e) {
                var f = a.substring(0,c),g = b.substring(0,d),a = a.substring(c),b = b.substring(d),
                    f                                                              = this.diff_main(f,g,!1,e),e                                 = this.diff_main(a,b,!1,e);
                return f.concat(e);
            };
            ...
            diff_match_patch.prototype.diff_cleanupSemantic = function (a) {
                for(var b = !1,c = [],d = 0,e = null,f = 0,g = 0,h = 0,j = 0,i = 0; f < a.length;) {
                    0 == a[f][0] ? (c[d++] = f, g = j, h = i, i = j = 0, e = a[f][1]) : (1 == a[f][0] ? j += a[f][1].length : i += a[f][1].length, e && e.length <= Math.max(g,h) && e.length <= Math.max(j,i) && (a.splice(c[d - 1],0,[
                        -1,e
                    ]), a[c[d - 1] + 1][0] = 1, d--, d--, f = 0 < d ? c[d - 1] : -1, i = j = h = g = 0, e = null, b = !0)), f++;
                }
                    ...
                    if (-1 == a[f - 1][0] && 1 == a[f][0]) {
                        ...
                        if (d >= e) {
                            if (d >= b.length / 2 || d >= c.length / 2) {
                                a.splice(f,0,[
                                    0,c.substring(0,d)
                                ]), a[f - 1][1] = b.substring(0,b.length - d), a[f + 1][1] = c.substring(d), f++;
                            }
                        } else if (e >= b.length / 2 || e >= c.length / 2) {
                            a.splice(f,0,[
                                0,b.substring(0,e)
                            ]), a[f - 1][0] = 1, a[f - 1][1] = c.substring(0,c.length - e), a[f + 1][0] = -1, a[f + 1][1] = b.substring(e), f++;
                        }
                        f++;
                    }
                    f++;
            ...
            diff_match_patch.prototype.diff_cleanupSemanticLossless = function (a) {
                function b(a,b) {
                    ...
                    var c = a.charAt(a.length - 1),d = b.charAt(0),
                ...
                for(var c = 1; c < a.length - 1;) {
                    if (0 == a[c - 1][0] && 0 == a[c + 1][0]) {
                        ...
                        if (g) {
                            var h                                     = e.substring(e.length - g),d       = d.substring(0,d.length - g),
            ...
            diff_match_patch.prototype.diff_cleanupEfficiency = function (a) {
                for(var b = !1,c = [],d = 0,e = null,f = 0,g = !1,h = !1,j = !1,i = !1; f < a.length;) {
                    if (0 == a[f][0]) {
                        ...
                        a.splice(c[d - 1],0,[
                            -1,e
                        ]), a[c[d - 1] + 1][0] = 1, d--, e = null, g && h ? (j = i = !0, d = 0) : (d--, f = 0 < d ? c[d - 1] : -1, j = i = !1), b = !0;
                    }
                    f++;
                }
                b && this.diff_cleanupMerge(a);
                ...
                for(var b = 0,c = 0,d = 0,e = '',f = '',g; b < a.length;) {
                    switch(a[b][0]) {
                        ...
                        case -1:
                            ...
                            break;
                        case 0:
                            1 < c + d ? (0 !== c && 0 !== d && (g = this.diff_commonPrefix(f,e), 0 !== g && (0 < b - c - d && 0 == a[b - c - d - 1][0] ? a[b - c - d - 1][1] += f.substring(0,g) : (a.splice(0,0,[
                                0,f.substring(0,g)
                            ]), b++), f = f.substring(g), e = e.substring(g)), g = this.diff_commonSuffix(f,e), 0 !== g && (a[b][1] = f.substring(f.length - g) + a[b][1], f = f.substring(0,f.length -
                                g), e = e.substring(0,e.length - g))), 0 === c ? a.splice(b - d,c + d,[
                                1,f
                            ]) : 0 === d ? a.splice(b - c,c + d,[-1,e]) : a.splice(b - c - d,c + d,[-1,e],[
                                1,f
                            ]), b = b - c - d + (c ? 1 : 0) + (d ? 1 : 0) + 1) : 0 !== b && 0 == a[b - 1][0] ? (a[b - 1][1] += a[b][1], a.splice(b,1)) : b++, c = d = 0, f = e = '';
                    }
                }
            ...
            diff_match_patch.prototype.diff_prettyHtml = function (a) {
                for(var b = [],c = /&/g,d = /</g,e = />/g,f = /\n/g,g = 0; g < a.length; g++) {
                    var h = a[g][0],j = a[g][1],j = j.replace(c,'&amp;').replace(d,'&lt;').replace(e,'&gt;')
                                                     .replace(f,'<span style="color: #dcdcdc;">&not;</span><br>');
                    switch(h) {
                        case 1:
            ...
            diff_match_patch.prototype.patch_addPadding = function (a) {
                ...
                if (0 == e.length || 0 != e[0][0]) {
                    e.unshift([
                        0,c
                    ]), d.start1 -= b, d.start2 -= b, d.length1 += b, d.length2 += b;
                        ...
                        for(var e = d.start1,f = d.start2,g = ''; 0 !== d.diffs.length;) {
                            ...
                            for(; 0 !== d.diffs.length && h.length1 < b - this.Patch_Margin;) {
                                ...
                                1 === g ? (h.length2 += i.length, f += i.length, h.diffs.push(d.diffs.shift()),
                                    j = !1) : -1 === g && 1 == h.diffs.length && 0 == h.diffs[0][0] && i.length > 2 * b ? (h.length1 += i.length, e += i.length, j = !1, h.diffs.push([
                                    g,i
                                ]), d.diffs.shift()) : (i = i.substring(0,b - h.length1 - this.Patch_Margin), h.length1 += i.length, e += i.length, 0 === g ? (h.length2 += i.length, f += i.length) : j = !1, h.diffs.push([
                                    g,i
                            ...
                            '' !== i &&
                            (h.length1 += i.length, h.length2 += i.length, 0 !== h.diffs.length && 0 === h.diffs[h.diffs.length - 1][0] ? h.diffs[h.diffs.length - 1][1] += i : h.diffs.push([
                                0,i
                            ]));
                            j || a.splice(++c,0,h);
                        }
    ...
    <body>
        <div id="topmost">
            ...
            <h5 style="float: left; display: inline; margin-top: 0; margin-bottom: 5px;"><a
                ...
                title="htmLawed home">HTM<big><big>L</big></big>AWED</a> <?php echo htmLawed::hl_version(); ?> <a
                href="htmLawedTest.php"
                title="test home">TEST</a></h5>
            ...
            <a
                ...
                onclick="javascript:toggle('inputF'); return false;"><span class="notice">Input &raquo;</span> <span
                class="help"
                title="limit lower with multibyte characters<?php echo(($_hlimit < $_limit && $_hlimit) ? '; limit is '.$_hlimit.' for viewing binaries' : ''); ?>"><small>(max. <?php echo htmlspecialchars($_limit); ?>
                        chars)</small></span></a>

            <form
                id="testform"
                name="testform"
                action="htmLawedTest.php"
                method="post"
                ...
                <div id="inputF" style="display: block;">
                    ...
                    <button
                        type="button"
                        title="Raw input rendered as web-page without a doctype or charset declaration"
                        style="float: right;"
                        onclick="javascript: sndUnproc(); return false;"
                        onkeypress="javascript: sndUnproc(); return false;">Render in webpage
                    </button>
                    <button
                        type="button"
                    ...
                    <button
                        type="button"
                        title="HTML 4.01 W3C online validation"
                        style="float: right;"
                    ...
                    <button
                        type="button"
                        title="XHTML 1.1 W3C online validation"
                        style="float: right;"
                    ...
                    <span
                        ...
                        style="font-size: 85%;">Encoding: </span><input
                        type="text"
                        size="8"
                        id="enc"
                        name="enc"
                ...
                <a
                    ...
                    onclick="javascript:toggle('inputC'); return false;"><span class="notice">Settings &raquo;</span></a>
                                ...
                                <ul>
                                    ...
                                    $cfg = ['abs_url'                                                       => ['3','0',
                                            ...
                                            'safe'                                                          => ['2','0',
                                                                                                                ...
                                                                                                                '0'],
                                            'schemes'                                                       => ['',
                                                                                                                'href: aim, app, feed, file, ftp, gopher, http, https, irc, javascript, mailto, news, nntp, sftp, ssh, telnet, tel; *:data, file, http, https, javascript',
            ...
            <div class="help">Use with a Javascript- and cookie-enabled, relatively new version of a common browser.
                ...
                <br/><br/>For anti-XSS tests, try the
                <a href="http://www.bioinformatics.org/phplabware/internal_utilities/htmLawed/htmLawedSafeModeTest.php"><span
                    class="notice">special test-page</span></a> or see
                <a href="http://www.bioinformatics.org/phplabware/internal_utilities/htmLawed/rsnake/RSnakeXSSTest.htm"><span
                    class="notice">these results</span></a>.

                <br/><br/>
                <small>Change <em>Encoding</em> to reflect the character encoding of the input text. Even then, it
                    may not work or some characters may not display properly because of variable browser support and
                    because of the form interface. Developers can write some PHP code to capture the filtered input
                    to a file if this is important.
                    <br/><br/>Refer to the htmLawed documentation
                    (<a href="htmLawed_README.htm"><span class="notice">htm</span></a>/<a href="htmLawed_README.txt"><span
                        class="notice">txt</span></a>) for details about <em>Settings</em>, and htmLawed's
                    behavior and limitations. For <em>Settings</em>, incorrectly-specified values like regular
                    expressions are silently ignored. One or more settings form-fields may have been disabled. Some
                    characters are not allowed in the <em>Spec</em> field.


                    <br/><br/>Hovering the mouse over some of the text can provide additional information in some
                    browsers.
                </small>
                ...
                <small><br/><br/>Because of character-encoding issues, the W3C validator (anyway not perfect)
                    may reject validation requests or invalidate otherwise-valid code, esp. if text was
                    copy-pasted in the input box. Local applications like the <em>HTML Validator</em> Firefox
                    browser add-on may be useful in such cases.
                </small>
