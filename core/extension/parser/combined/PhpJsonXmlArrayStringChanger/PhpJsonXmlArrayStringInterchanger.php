 ...
 * @package PhpJsonXmlArrayStringChanger
 * @version beta
 */
class PhpJsonXmlArrayStringChanger {
    ...
    public function convertArrayToXML($array) {
        $return = "<?xml version='1.0' encoding='ISO-8859-1'?><PhpJsonXmlArrayStringChanger>";
        $return.=$this->parseArray($array);
        $return.="</PhpJsonXmlArrayStringChanger>";
        return $return;
    }
