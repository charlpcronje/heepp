...
trait importMimeTypes {    
    ...
    public $mimeTypes = [
        ...
        'gif' => [
            ...
            'import' => [
                ...
                'options' => [
                    'width' => '',                  // Width in Pixels without the 'px'. If Resize == true then the actual image will be resized on the server. If you specify only the width or height the corrosponding axis will be calculated automatically
            ...
            'import' => [
                ...
                'tags' => [
                    ...
                    'img' => [
                        ...
                        'options' => [
                            'width' => '',                      // Width in Pixels without the 'px'. If Resize == true then the actual image will be re-sized on the server. If you specify only the width or height the corrosponding axis will be calculated automatically
                            'height' => '',                     // Height in Pixels without the 'px'
                            'title' => ''                       // Not an Official Image attribute but works well for displaying more information onMouseOver
                        ]
                    ]
        ...
        'htc' => [
            ...
            'import' => [
                ...
                'options' => [                 // The download_only indicates that PHP will force a download on the file
                    'trigger' => 'click',           // What will Trigger The Download?. trigger, auto. With trigger you have to specify a trigger(click,delay]. Click has to specify specify an element(s] with a jquery selector. Delay you have to specifiy the delay in seconds.
    ...
    public $mimeTypeProperties = [                    // array of properties per mineType that is relevant to that type. if mimeType extension don't exist, use default
        'global'=>[
            'project'=>PROJECT,                             // Your Current Project name
            'dataFile'=>CACHED_FILES_PATH.'file.che',       // Data File For Cached Imports
            ...
            'projectWithPath'=>null,                        // MD5(raw] Hash of PROJECT Path concatenated With Path
            ...
            'fileContent'=>null,                            // Hold The Current File Content
            ...
            'cacheFolder'=>CACHED_FILES_PATH,               // Cache Folder
            'characterSetEncodeFile'=>false,                // Must The File Be Encoded With $characterSet
        ...
        'webImages'=>[            
            ...
            'resizeImages'=>true,                           // Resize Images to The Max width and height
            'maxImageSize'=>[                          // Image Max Sizes, The Images will be re-sized to be smaller than max sizes
                'width' => 1000,
                'height' => 1000
            ],'resizeImagesToSetDimentions'=>true,            // This will let the server resize the image to the actual size set by in the attributes in HTML. Ex: <img src="img_url" width="100" height="150"/> will resize the image on the server to 100px wide and 150 in height and serve the resized image to the browser
    ...
    public $fileEncodingChecks = [
        'minify'=>[
            'checkImportProperty'=>'minify',
            'checkElementProperty'=>'minify'
        ]
    ];
