...
class SimpleImage extends Extension {
    public $image;
    public $image_type;
    ...
    public function resize($width,$height,$forcesize = 'n') {
        ...
        $new_image = imagecreatetruecolor(floatval($width),floatval($height));
        ...
        imagecopyresampled($new_image,$this->image,0,0,0,0,floatval($width),floatval($height),floatval($this->getWidth()),floatval($this->getHeight()));
